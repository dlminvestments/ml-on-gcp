...
def test_mnist(gcs_bucket_prefix, submit_script):
    ...
    if 'saved_model.pb' not in out_str:
        raise AssertionError('Artifact "saved_model.pb" not found in bucket {} with prefix {} after {} seconds.'.format(bucket, prefix, WAIT_TIME))
