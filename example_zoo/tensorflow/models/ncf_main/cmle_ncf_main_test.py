...
def test_ncf_main(gcs_bucket_prefix, submit_script):
    ...
    if 'timeline-1000.json' not in out_str:
        raise AssertionError('Artifact "timeline-1000.json" not found in bucket {} with prefix {} after {} seconds.'.format(bucket, prefix, WAIT_TIME))
