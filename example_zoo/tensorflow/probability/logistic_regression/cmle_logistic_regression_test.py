...
def test_logistic_regression(gcs_bucket_prefix, submit_script):
    ...
    if 'weights_inferred.png' not in out_str:
        raise AssertionError('Artifact "weights_inferred.png" not found in bucket {} with prefix {} after {} seconds.'.format(bucket, prefix, WAIT_TIME))
