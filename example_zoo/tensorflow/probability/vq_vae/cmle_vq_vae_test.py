...
def test_vq_vae(gcs_bucket_prefix, submit_script):
    ...
    if 'validation_reconstructions.png' not in out_str:
        raise AssertionError('Artifact "validation_reconstructions.png" not found in bucket {} with prefix {} after {} seconds.'.format(bucket, prefix, WAIT_TIME))
