...
def test_grammar_vae(gcs_bucket_prefix, submit_script):
    ...
    if '-1.data-00000-of-00001' not in out_str:
        raise AssertionError('Artifact "-1.data-00000-of-00001" not found in bucket {} with prefix {} after {} seconds.'.format(bucket, prefix, WAIT_TIME))
