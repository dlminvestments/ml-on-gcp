...
def test_latent_dirichlet_allocation_edward2(gcs_bucket_prefix, submit_script):
    ...
    if '.data-00000-of-00001' not in out_str:
        raise AssertionError('Artifact ".data-00000-of-00001" not found in bucket {} with prefix {} after {} seconds.'.format(bucket, prefix, WAIT_TIME))
