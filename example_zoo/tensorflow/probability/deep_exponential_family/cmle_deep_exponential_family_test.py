...
def test_deep_exponential_family(gcs_bucket_prefix, submit_script):
    ...
    if 'events.out.tfevents' not in out_str:
        raise AssertionError('Artifact "events.out.tfevents" not found in bucket {} with prefix {} after {} seconds.'.format(bucket, prefix, WAIT_TIME))
